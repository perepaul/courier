...
<article>
    ...
    <section class="banner banner-style2 mask-overlay pt-120 white-clr">
        ...
        <div class="container theme-container rel-div">
            ...
            <h4 class="section-title effect animated wow fadeInUp" style="color:black" data-wow-offset="50" data-wow-delay=".20s"> <span class="fs-36">Overseas Link Express. </span>  <br> <span class="theme-clr fs-16"> courier  &  Diplomatic delivery services</span>  </h4>
                    ...
                    <form method="POST" action="{{route('shipment.tracking')}}">
                        ...
                        <div class="col-md-7 col-sm-7">
                            <div class="form-group">
                                <input type="text" name="code" class="form-control box-shadow" required="" placeholder="Enter your product ID">
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="about-us">
                        ...
                        Overseas Link Express Inc. is a Canadian integrated shipping company, active in ocean and inland freight transportation and associated with  Diplomatic Delivery Services, such as supply chain management 
                        and port operation. Overseas Link Express has a large container ship and supply vessel operator in the world since 1996.
                        ...
                        <p class="wow fadeInRight" data-wow-offset="50" data-wow-delay=".25s"><strong>Founder:</strong> Benjamin Logan.</p>
                    </div>
                </div>
        ...
        <div class="theme-container container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p class="fs-16 wow fadeInUp" data-wow-offset="50" data-wow-delay=".25s">
                        Our pricing estimator for senders. Fill out the form below and get an estimated delivery charge for your parcel.
                    </p>
            ...
            <div class="row">
                <div class="col-md-11 col-md-offset-1">
                    <div class="pt-120 rel-div">
                        ...
                        <p class="fs-16 wow fadeInUp" data-wow-offset="50" data-wow-delay=".25s">From sending parcels, documents, cargos, containers and <br>deplomatic delivery services
