                ...
                <div class="row">
                    <div class="col-sm-8 pull-left">
                        <div class="title-wrap">
                            <h2 class="section-title no-margin"> package tracking </h2>
        ...
        <div class="container theme-container ">
            <div class="row pad-10">
                <div class="col-md-8 col-md-offset-2 tracking-form wow fadeInUp" data-wow-offset="50" data-wow-delay=".30s">
                    <h2 class="title-1"> track your package </h2> <span class="font2-light fs-12">Now you can track your packages easily</span>
                    <div class="row">
                        <form action="{{route('shipment.tracking')}}" method="post">
                            @csrf
                            <div class="col-md-7 col-sm-7">
                                <div class="form-group">
                                    <input type="text" name="code" placeholder="Enter your package ID" required="" class="form-control box-shadow">
                                </div>
                            </div>
                ...
                <div class="col-md-5 pad-30 wow fadeInRight" data-wow-offset="50" data-wow-delay=".30s">
                    <div class="prod-info white-clr">
                        <ul>
                            ...
                            <li> <span class="title-2">order date:</span> <span class="fs-16">{{$shipment->created_at?->format('d m, Y')}}</span> </li>
            ...
            <!-- <div class="progress-wrap">
                    ...
                    <div class="row progress-content upper-text">
                        ...
                        <div class="text-center col-md-4 col-xs-8 col-sm-4">
                        ...
                        <div class="text-right col-md-2 col-xs-8 col-sm-2">
