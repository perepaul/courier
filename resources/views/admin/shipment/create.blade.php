                    ...
                    <div class="row">
                        <div class="col m6 s12">
                            <div class="input-field">
                                <input id="full-n" type="text" name="name" class="@error('name') error @enderror" name="phone">
                        ...
                        <div class="col m6 s12">
                            <div class="input-field">
                                <input id="title" type="text" class="@error('phone') error @enderror" name="phone">
                        ...
                        <div class="col s12">
                            <div class="input-field">
                                <input id="com1" type="text" name="address" class="@error('address') error @enderror">
                        ...
                        <div class="col s12 m6 l6">
                            <div class="input-field">
                                <input id="em1" type="email" name="email" class="@error('email') error @enderror">
                        ...
                        <div class="input-field col s12">
                            <textarea id="description" name="description" class="@error('description') error @enderror materialize-textarea"></textarea>
                        ...
                        <div class="col s12 m4">
                            <div class="input-field">
                                <input id="poiodjfpoiejfpojdfpiop" class="@error('quantity') error @enderror" type="text" name="quantity">
                        ...
                        <div class="col s12 m4">
                            <div class="input-field">
                                <input id="idifoiidnf" type="text" class="@error('insurance') error @enderror" name="insurance">
                        ...
                        <div class="col s12 m4">
                            <div class="input-field">
                                <input id="oiodfoidnfoidf" class="@error('price') error @enderror" type="text" name="price">
