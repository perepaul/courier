                ...
                <form action="{{route('shipment.update',$shipment->id)}}" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col s12 m6">
                            <div class="input-field">
                                <input id="oiodfoidnfoidf" class="@error('created_at') error @enderror" type="date" name="created_at" value="{{$shipment->created_at->format('Y-m-d')}}">
                        ...
                        <div class="col s12 m6">
                            <div class="input-field">
                                <input id="oiodfoidnfoidf" class="@error('delivered_at') error @enderror" type="date" name="delivered_at" value="{{$shipment->delivered_at->format('Y-m-d')}}">
