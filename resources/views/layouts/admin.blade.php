                        ...
                        <div id="activity" class="col s12">
                            <div class="m-t-10 p-10">
                                ...
                                <div class="steamline">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="circle" alt="user" src="{{asset('uploads/images/users/2.jpg')}}"> </div>
                                        <div class="sl-right">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="circle" alt="user" src="{{asset('uploads/images/users/1.jpg')}}"> </div>
                                        <div class="sl-right">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="circle" alt="user" src="{{asset('uploads/images/users/4.jpg')}}"> </div>
                                        <div class="sl-right">
                                            <div class="font-medium">Go to the Doctor <span class="sl-date">5 minutes ago</span></div>
                                            <div class="desc">Contrary to popular belief</div>
                                        </div>
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="circle" alt="user" src="{{asset('uploads/images/users/6.jpg')}}"> </div>
                                        <div class="sl-right">
                                            <div><a href="javascript:void(0)">Stephen</a> <span class="sl-date">5 minutes ago</span></div>
                                            <div class="desc">Approve meeting with tiger</div>
                                        </div>
